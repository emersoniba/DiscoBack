...
class UsuarioSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if not validated_data.get('username') and persona:
            # OPTIMIZACIÓN: Reutiliza el método de PersonaSerializer en lugar de duplicar código
            persona_serializer = PersonaSerializer()
            validated_data['username'] = persona_serializer.get_username_generado(persona)
